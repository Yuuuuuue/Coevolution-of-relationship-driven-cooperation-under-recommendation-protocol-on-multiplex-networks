...
gamma_values = np.arange(0, 1.1, 0.1)  # p的取值从0.5到1，每次增加0.05
mean_cooperator_ratios = []  # 用于存储每次实验的平稳状态下合作者比例均值

# 实验循环
for gamma in gamma_values:
    print(f"Running experiment with γ = {gamma}")
    edge_weights = {}  # 存储边的权值和对应的节点

    # 初始化网络
    G_coop = nx.watts_strogatz_graph(2500, k=10, p=0.5)  # 第一层：合作网络
...
# 打印最终结果
print("Mean Cooperator Ratios for each p value:", mean_cooperator_ratios)
